...
<div class="container indmain1">
    <div class="row">
        <div class="col-lg-12 ">
            ...
            <h1 class="indmainh1">Illustration Stall</h1>
        ...
        <div class="col-lg-8 col-md-8 col-sm-12 ">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="indboxs">
                        <a style="text-decoration: none;" href="{{url('vendor/illustration')}}">
                        <img src="assets/images/Capture.PNG" alt="">
                        <h3 class="indboxh3">Illustration</h3>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="indboxs">
                        <a style="text-decoration: none;"   href="{{url('vendor/photo')}}">
                        <img src="assets/images/Capture.PNG" alt="">
