@extends('layouts.vendor') @section('title','Vector') @section('content')
    ...
    <nav class="gn-menu-wrapper gn-menu-main gn-open-part">
        <div class="gn-scroller">
            <ul id="myDIV" class="gn-menu">
                <li><a href="index.html" class="gn-icon fa fa-home"></a></li>
                <li><a href="icon.html" class="gn-icon fa fa-eercast"></a></li>
                <li><a href="illustrations.html" class="gn-icon fa fa-ravelry"></a></li>
                <li><a href="3d.html" class="gn-icon fa fa-cube"></a></li>
                <li class="active"><a href="animation.html" class="gn-icon fa fa-cube"></a></li>
                <li><a href="stats.html" class="gn-icon fa fa-bar-chart"></a></li>
                <li><a href="cashout.html" class="gn-icon fa fa-money"></a></li>
                <li><a class="gn-icon fa fa-id-badge"></a></li>
                <li><a href="contributorterms.html" class="gn-icon gn-icon-help"></a></li>
            </ul>
        </div>
        <!-- /gn-scroller -->
    </nav>
