...
<html lang="en">
  <head>
    ...
    <title>Vendor Dashboard - Rejected</title>
  </head>
  <body>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-lg-2 col-md-2 col-sm-12 col-12 drtaall text-center">
      <img src="assets/images/pack12.png" style="width: 100%;height: 130px;border:1px solid black;border-radius: 8px;" alt="">
...
<div style="background-color: transparent;" class="tab-pane" id="tabs-2" role="tabpanel">
 <div class="row">
    <div class="col-lg-2 col-md-2 col-sm-12 col-12 drtaall text-center">
      <img src="assets/images/9880bfc0-d260-11eb-936a-1fc051d77cb2.png" class="daraftallimg" alt="">
      <i class="fa fa-ellipsis-v alldraftfa"></i>
      <span class="text-black">no name</span><span class="uploadp ml-1">(0 icons)</span>
    </div>
  </div>
