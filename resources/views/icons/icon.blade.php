...
<div class="container indmain1">
    <div class="row">
        <div class="col-lg-12 text-center">
            <h1 class="indmainh1 ml-5">My Icons</h1>
        </div>
    </div>
    <div class="row">
        <div class=" offset-lg-2 col-lg-3  col-md-6 col-sm-12 col-12">
             <div class="indboxs pt-3 pr-3 pl-3">
                 <a style="text-decoration: none !important;" href="{{url('vendor/icon/upload')}}">
        ...
        <div class="col-lg-3  col-md-6 col-sm-12 col-12">
             <div class="indboxs">
             <a href="{{url('vendor/icons/live-store')}}">
                    <div>
        ...
        <div class=" col-lg-3  col-md-6 col-sm-12 col-12">
              <div class="indboxs">
                 <a href="{{url('vendor/icon-drafts-show')}}">
                    <div>
                      <img src="{{asset('assets/images/c3.PNG')}}"  alt="">
    ...
    <div class="row">
        <div class=" offset-lg-2 col-lg-3  col-md-6 col-sm-12 col-12">
             <div class="indboxs">
             <a href="{{url('vendor/icons/review')}}">
                    <div>
        ...
        <div class="col-lg-3  col-md-6 col-sm-12 col-12">
             <div class="indboxs">
                 <a href="{{url('vendor/icons/needtoimprove')}}">
                    <div>
        ...
        <div class=" col-lg-3  col-md-6 col-sm-12 col-12">
             <div class="indboxs">
                  <a href="{{url('vendor/icons/rejected')}}">
                    <div>
