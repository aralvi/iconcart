...
<span class="indmainh1 mt-2">My Drafts</span><span class="uploadp ml-3">1 Icons</span>
{}
</div>
<div class="col-lg-9 col-md-12 col-sm-12 col-12">
<div class="row float-right">
<div class="uploadrowbt2">
<button class="btn uploadexmbt2"><a href="{{ route('save.drafts',$products['id']) }}" onclick="event.preventDefault();  document.getElementById('savedrafts-form').submit();">Save Draft</a>
<form id="savedrafts-form" action="{{ route('save.drafts',$products['id']) }}" method="POST" style="display: none;">
    @csrf
</form>
</button>
</div>
<div class="uploadrowbt2">
<button class="btn uploadexmbt2"><a href="{{route('product-delete',$products['id'])}}"></a> Delete Draft</button>
</div>
<div class="uploadrowbt2">
...
<div class="uploadrowbt2">
<button class="btn uploadexmbt2"><a href="{{ route('submit-as-pack.drafts',$products['id']) }}" onclick="event.preventDefault();  document.getElementById('review-form').submit();">Submit as pack</a>
<form id="review-form" action="{{ route('submit-as-pack.drafts',$products['id']) }}" method="POST" style="display: none;">
    @csrf
</form>
</button>
</div>
...
<div class="draftouterdiv mt-4">
  <div class="text-center">
    <img src="{{url('public/images/icons/'.$products['name'])}}" class="draftimg1" alt="">
  </div>



  <div class="row" style="border-top: 1px solid #d8dbeb;
  border-bottom: 1px solid #d8dbeb;width: 99%;margin: auto;">
  <input type="hidden" class="draftin2" value="{{$products['id']}}" name="id" id="">
    <div class="col-lg-10 col-md-10 col-sm-9 col-9">
      <input type="text" class="draftin1" value="{{$products['name']}}" name="" id="">
    </div>
